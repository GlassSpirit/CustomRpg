...
public class EntityAIMoveIndoors extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (this.theCreature.world.isDaytime() && !this.theCreature.world.isRaining() || theCreature.world.provider.hasSkyLight())
            return false;
        BlockPos pos = new BlockPos(theCreature.posX, this.theCreature.getEntityBoundingBox().minY, theCreature.posZ);
