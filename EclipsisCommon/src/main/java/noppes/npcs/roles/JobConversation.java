...
public class JobConversation extends JobInterface {
    ...
    public void aiUpdateTask() {
        ...
        if (nextLine != null)
            ...
            List<EntityPlayer> inRange = npc.world.getEntitiesWithinAABB(EntityPlayer.class, npc.getEntityBoundingBox().grow(range, range, range));
    ...
    private boolean shouldRun() {
        ...
        if (ticks > 0)
            return false;
        npcs.clear();
        List<EntityNPCInterface> list = npc.world.getEntitiesWithinAABB(EntityNPCInterface.class, npc.getEntityBoundingBox().grow(10, 10, 10));
