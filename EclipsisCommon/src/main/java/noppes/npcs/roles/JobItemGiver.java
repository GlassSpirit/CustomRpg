...
public class JobItemGiver extends JobInterface {
    ...
    private boolean giveItems(EntityPlayer player) {
        ...
        if (isAllGiver()) {
            ...
            toGive.add(items.get(npc.world.rand.nextInt(items.size())).copy());
    ...
    private int getDay() {
        return (int) (npc.world.getTotalWorldTime() / 24000L);
    }
    ...
    public boolean aiShouldExecute() {
        ...
        toCheck = npc.world.getEntitiesWithinAABB(EntityPlayer.class, npc.getEntityBoundingBox().grow(3, 3, 3));
        toCheck.removeAll(recentlyChecked);

        List<EntityPlayer> listMax = npc.world.getEntitiesWithinAABB(EntityPlayer.class, npc.getEntityBoundingBox().grow(10, 10, 10));
