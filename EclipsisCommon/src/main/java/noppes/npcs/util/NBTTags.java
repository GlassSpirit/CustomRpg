...
public class NBTTags {
    ...
    public static List<int[]> getIntegerArraySet(NBTTagList tagList) {
    ...
    public static Map<Integer, Boolean> getBooleanList(NBTTagList tagList) {
    ...
    public static Map<Integer, Integer> getIntegerIntegerMap(
            NBTTagList tagList) {
    ...
    public static Map<Integer, Long> getIntegerLongMap(
            NBTTagList tagList) {
    ...
    public static Map<String, Vector<String>> getVectorMap(NBTTagList tagList) {
    ...
    public static NBTTagList nbtBooleanList(Map<Integer, Boolean> updatedSlots) {
        NBTTagList nbttaglist = new NBTTagList();
