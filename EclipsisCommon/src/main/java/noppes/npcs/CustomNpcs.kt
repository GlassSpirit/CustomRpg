...
@Mod(modid = CustomNpcs.MODID, name = CustomNpcs.MODNAME, version = CustomNpcs.VERSION,
        dependencies = CustomNpcs.DEPENDENCIES, modLanguageAdapter = CustomNpcs.ADAPTER)
object CustomNpcs {
    ...
    private const val SERVER = "noppes.npcs.CommonProxy"
