...
public class DataTransform {
    ...
    public NBTTagCompound getJob() {
        ...
        if (npc.advanced.job != JobType.NONE && npc.jobInterface != null) {
    ...
    public NBTTagCompound getRole() {
        ...
        if (npc.advanced.role != RoleType.NONE && npc.roleInterface != null) {
    ...
    public NBTTagCompound getAdvanced() {
        ...
        npc.advanced.job = JobType.NONE;
        npc.advanced.role = RoleType.NONE;
