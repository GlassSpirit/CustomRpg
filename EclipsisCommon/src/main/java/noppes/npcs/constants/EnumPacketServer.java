...
public enum EnumPacketServer {
    ...
    MainmenuAISave(CustomNpcsPermissions.NPC_ADVANCED, true), MainmenuAIGet(true),
    ...
    DoorSave(CustomNpcsPermissions.TOOL_SCRIPTER), DoorGet,
    ScriptDataSave(CustomNpcsPermissions.TOOL_SCRIPTER, true), ScriptDataGet(true),
    ScriptBlockDataSave(CustomNpcsPermissions.TOOL_SCRIPTER, false), ScriptBlockDataGet(false),
    ScriptDoorDataSave(CustomNpcsPermissions.TOOL_SCRIPTER, false), ScriptDoorDataGet(false),
    ScriptPlayerSave(CustomNpcsPermissions.TOOL_SCRIPTER, false), ScriptPlayerGet(false),
    ScriptItemDataSave(CustomNpcsPermissions.TOOL_SCRIPTER, false), ScriptItemDataGet(false),
    ScriptForgeSave(CustomNpcsPermissions.TOOL_SCRIPTER, false), ScriptForgeGet(false),
    DialogNpcGet,
    ...
    DimensionsGet, DimensionTeleport, GetTileEntity, Gui, SchematicsTile, SchematicsSet, SchematicsBuild, SchematicsTileSave, SchematicStore,

    SceneStart(CustomNpcsPermissions.SCENES), SceneReset(CustomNpcsPermissions.SCENES),
    NbtBookSaveEntity(CustomNpcsPermissions.TOOL_NBTBOOK), NbtBookSaveBlock(CustomNpcsPermissions.TOOL_NBTBOOK),
    ;
