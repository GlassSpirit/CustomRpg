...
public class GuiNpcBard extends GuiNPCInterface2 implements ISubGuiListener {
    ...
    public void initGui() {
        ...
        addTextField(new GuiNpcTextField(2, this, this.fontRenderer, guiLeft + 160, guiTop + 138, 40, 20, job.minRange + ""));
        ...
        addTextField(new GuiNpcTextField(3, this, this.fontRenderer, guiLeft + 160, guiTop + 184, 40, 20, job.maxRange + ""));
