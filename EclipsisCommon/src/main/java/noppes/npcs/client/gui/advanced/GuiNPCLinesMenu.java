...
public class GuiNPCLinesMenu extends GuiNPCInterface2 {
    ...
    public void initGui() {
        super.initGui();
        this.addButton(new GuiNpcButton(0, guiLeft + 85, guiTop + 20, "lines.world"));
        this.addButton(new GuiNpcButton(1, guiLeft + 85, guiTop + 43, "lines.attack"));
        this.addButton(new GuiNpcButton(2, guiLeft + 85, guiTop + 66, "lines.interact"));
        this.addButton(new GuiNpcButton(5, guiLeft + 85, guiTop + 89, "lines.killed"));
        this.addButton(new GuiNpcButton(6, guiLeft + 85, guiTop + 112, "lines.kill"));
        this.addButton(new GuiNpcButton(7, guiLeft + 85, guiTop + 135, "lines.npcinteract"));

        this.addLabel(new GuiNpcLabel(16, "lines.random", guiLeft + 85, guiTop + 157));
