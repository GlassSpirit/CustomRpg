...
public class GuiTransportSelection extends GuiNPCInterface implements ITopButtonListener, IScrollData {
    ...
    public void initGui() {
        ...
        String name = "";
        addLabel(new GuiNpcLabel(0, name, guiLeft + (xSize - this.fontRenderer.getStringWidth(name)) / 2, guiTop + 10));
        addButton(new GuiNpcButton(0, guiLeft + 10, guiTop + 192, 156, 20, I18n.translateToLocal("transporter.travel")));
        if (scroll == null)
