...
public class GuiNpcTextArea extends GuiNpcTextField {
            ...
            for (char c : wholeLine.toCharArray()) {
                if (font.width(line + c) > maxSize && wrapLine) {
                    if (lineCount >= startLine && lineCount < maxLine)
                        drawString(null, line, posX + 4, posY + 4 + ((lineCount - startLine) * font.height(line)), color);
                    line = "";
                    lineCount++;
                }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        tessellator.pos(p_146188_1_, p_146188_4_, 0.0D).endVertex();
        tessellator.pos(p_146188_3_, p_146188_4_, 0.0D).endVertex();
        tessellator.pos(p_146188_3_, p_146188_2_, 0.0D).endVertex();
        tessellator.pos(p_146188_1_, p_146188_2_, 0.0D).endVertex();
