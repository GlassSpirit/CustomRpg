...
public class SubGuiNpcAvailabilityQuest extends SubGuiInterface implements GuiSelectionListener {
    ...
    public void initGui() {
        ...
        int y = guiTop + 12;
        this.addButton(new GuiNpcButton(0, guiLeft + 4, y, 90, 20, new String[]{"availability.always", "availability.after", "availability.before", "availability.whenactive", "availability.whennotactive", "availability.completed"}, availabitily.questAvailable.ordinal()));
        ...
        y += 23;
        this.addButton(new GuiNpcButton(1, guiLeft + 4, y, 90, 20, new String[]{"availability.always", "availability.after", "availability.before", "availability.whenactive", "availability.whennotactive", "availability.completed"}, availabitily.quest2Available.ordinal()));
        ...
        y += 23;
        this.addButton(new GuiNpcButton(2, guiLeft + 4, y, 90, 20, new String[]{"availability.always", "availability.after", "availability.before", "availability.whenactive", "availability.whennotactive", "availability.completed"}, availabitily.quest3Available.ordinal()));
        ...
        y += 23;
        this.addButton(new GuiNpcButton(3, guiLeft + 4, y, 90, 20, new String[]{"availability.always", "availability.after", "availability.before", "availability.whenactive", "availability.whennotactive", "availability.completed"}, availabitily.quest4Available.ordinal()));
