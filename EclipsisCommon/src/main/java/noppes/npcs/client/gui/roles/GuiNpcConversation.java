...
public class GuiNpcConversation extends GuiNPCInterface2 implements ITextfieldListener, GuiSelectionListener {
    ...
    public void initGui() {
        ...
        addTextField(new GuiNpcTextField(50, this, fontRenderer, guiLeft + 260, guiTop + 170, 40, 20, job.generalDelay + ""));
        ...
        addTextField(new GuiNpcTextField(54, this, fontRenderer, guiLeft + 260, guiTop + 191, 40, 20, job.range + ""));
