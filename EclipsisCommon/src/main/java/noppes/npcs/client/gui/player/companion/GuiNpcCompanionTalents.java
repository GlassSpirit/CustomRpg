...
public class GuiNpcCompanionTalents extends GuiNPCInterface {
    ...
    private Map<Integer, GuiTalent> talents = new HashMap<>();
    ...
    public void actionPerformed(GuiButton guibutton) {
        ...
        if (id >= 10) {
            ...
            lastPressedTime = startPressedTime = mc.world.getWorldTime();
            addExperience(1);
        }
    }
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if (selected != null && mc.world.getWorldTime() - startPressedTime > 4 && lastPressedTime < mc.world.getWorldTime() && mc.world.getWorldTime() % 4 == 0) {
