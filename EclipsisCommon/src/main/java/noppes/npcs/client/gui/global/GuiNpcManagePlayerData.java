...
public class GuiNpcManagePlayerData extends GuiNPCInterface2 implements IScrollData, ICustomScrollListener {
    ...
    public void initGui() {
        ...
        this.addButton(new GuiNpcButton(1, guiLeft + 200, guiTop + 32, 98, 20, "playerdata.players"));
        this.addButton(new GuiNpcButton(2, guiLeft + 200, guiTop + 54, 98, 20, "quest.quest"));
        this.addButton(new GuiNpcButton(3, guiLeft + 200, guiTop + 76, 98, 20, "dialog.dialog"));
        this.addButton(new GuiNpcButton(4, guiLeft + 200, guiTop + 98, 98, 20, "global.transport"));
        this.addButton(new GuiNpcButton(5, guiLeft + 200, guiTop + 120, 98, 20, "role.bank"));
        this.addButton(new GuiNpcButton(6, guiLeft + 200, guiTop + 142, 98, 20, "menu.factions"));
