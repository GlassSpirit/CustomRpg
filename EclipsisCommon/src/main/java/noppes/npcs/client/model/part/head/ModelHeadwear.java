...
public class ModelHeadwear extends ModelScaleRenderer {
    ...
    public ModelHeadwear(ModelBase base) {
        ...
        Model2DRenderer right = new Model2DRenderer(base, 32, 8, 8, 8);
        ...
        Model2DRenderer left = new Model2DRenderer(base, 48, 8, 8, 8);
        ...
        Model2DRenderer front = new Model2DRenderer(base, 40, 8, 8, 8);
        ...
        Model2DRenderer back = new Model2DRenderer(base, 56, 8, 8, 8);
        ...
        Model2DRenderer top = new Model2DRenderer(base, 40, 0, 8, 8);
        ...
        Model2DRenderer bottom = new Model2DRenderer(base, 48, 0, 8, 8);
