...
public class MarkRenderer {
    ...
    public static void render(EntityLivingBase entity, double x, double y, double z, Mark mark) {
        ...
        if (displayList >= 0) {
            ...
            Model2DRenderer.renderItemIn2D(Tessellator.getInstance().getBuffer(), 0f, 0f, 1f, 1f, 32, 32, 0.0625F);
            GL11.glEndList();
        }
